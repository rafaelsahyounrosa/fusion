...
class MTECorpusReader(TaggedCorpusReader):
    ...
    def __init__(self, root=None, fileids=None, encoding="utf-8"):
        """
        Construct a new MTECorpusreader for a set of documents
        located at the given root directory.  Example usage:

            >>> root = '/...path to corpus.../'
            >>> reader = MTECorpusReader(root, 'oana-*.xml', 'utf-8') # doctest: +SKIP
        ...
        :param enconding: The encoding of the given files (default is utf-8)
        """
