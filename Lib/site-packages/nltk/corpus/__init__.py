...
abc = LazyCorpusLoader(
    ...
    r"(?!\.).*\.txt",
    encoding=[("science", "latin_1"), ("rural", "utf-8")],
)
...
conll2007 = LazyCorpusLoader(
    ...
    r".*\.(test|train).*",
    encoding=[("eus", "ISO-8859-2"), ("esp", "utf-8")],
)
...
indian = LazyCorpusLoader(
    "indian", IndianCorpusReader, r"(?!\.).*\.pos", tagset="unknown", encoding="utf-8"
)
...
product_reviews_1 = LazyCorpusLoader(
    "product_reviews_1", ReviewsCorpusReader, r"^(?!Readme).*\.txt", encoding="utf-8"
)
product_reviews_2 = LazyCorpusLoader(
    "product_reviews_2", ReviewsCorpusReader, r"^(?!Readme).*\.txt", encoding="utf-8"
)
...
swadesh = LazyCorpusLoader(
    "swadesh", SwadeshCorpusReader, r"(?!README|\.).*", encoding="utf-8"
)
swadesh110 = LazyCorpusLoader(
    'panlex_swadesh', PanlexSwadeshCorpusReader, r'swadesh110/.*\.txt', encoding='utf-8'
)
swadesh207 = LazyCorpusLoader(
    'panlex_swadesh', PanlexSwadeshCorpusReader, r'swadesh207/.*\.txt', encoding='utf-8'
)
...
udhr2 = LazyCorpusLoader("udhr2", PlaintextCorpusReader, r".*\.txt", encoding="utf-8")
...
wordnet = LazyCorpusLoader(
    "wordnet",
    WordNetCorpusReader,
    LazyCorpusLoader("omw", CorpusReader, r".*/wn-data-.*\.tab", encoding="utf-8"),
)
...
#     'mwa_ppdb', MWAPPDBCorpusReader, r'(?!README|\.).*', nltk_data_subdir='misc', encoding='utf-8')
...
#     cat_file='cats.txt', textid_file='textids.txt', encoding='utf-8')
#
# ipipan = LazyCorpusLoader(
#     'ipipan', IPIPANCorpusReader, r'(?!\.).*morph\.xml')
#
# nkjp = LazyCorpusLoader(
#     'nkjp', NKJPCorpusReader, r'', encoding='utf-8')
#
