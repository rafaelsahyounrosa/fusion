...
decode_utf-8 = decode_string
encode_utf-8 = encode_string
...
def _read(path, encoding="utf-8", comment=";;;"):
    ...
    if path:
        ...
        for i, line in enumerate(f):
            line = line.strip(codecs.BOM_utf-8) if i == 0 and isinstance(line, binary_type) else line
            line = line.strip()
            line = decode_utf-8(line)
