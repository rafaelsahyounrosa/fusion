...
from . import (lookup, LABELS, decode, encode, iter_decode, iter_encode,
               IncrementalDecoder, IncrementalEncoder, utf-8)
...
def test_decode():
    ...
    assert decode(b'\xc3\xa9', 'utf-8') == ('é', lookup('utf-8'))
    assert decode(b'\xc3\xa9', utf-8) == ('é', lookup('utf-8'))
    assert decode(b'\xc3\xa9', 'ascii') == ('Ã©', lookup('ascii'))
    assert decode(b'\xEF\xBB\xBF\xc3\xa9', 'ascii') == ('é', lookup('utf-8'))  # UTF-8 with BOM
...
def test_encode():
    ...
    assert encode('é', 'utf-8') == b'\xc3\xa9'
    assert encode('é', 'utf-8') == b'\xc3\xa9'
